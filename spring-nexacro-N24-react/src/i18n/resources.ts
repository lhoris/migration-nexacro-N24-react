...
export const RESOURCES: Record<LangCode, Record<string, string>> = {
  ko: {
    ...
    "grid.dynamic": "동적 그리드",
    "grid.dynamic.desc": "좌측 그리드에 셀 타입을 드래그 하여 우측 그리드에 드랍해 양식을 완성한다.",
    "grid.dynamic.save": "양식저장",
    "grid.dynamic.save.desc": "양식저장 완료!",
    "grid.dynamic.init.desc": "양식초기화 완료!",
    "grid.dynamic.add": "행/열추가",
    "grid.dynamic.add.desc": "그리드에서 우클릭 후 컨택스트 메뉴에서 동적으로 행추가 및 열추가 한다.",
    "grid.dynamic.merge": "행병합",
    "grid.dynamic.merge.desc": "그리드에서 드래그 앤 드랍으로 셀 영역을 선택 한 후 우클릭 하여 열병합을 한다. 마찬가지 방법으로 열병합을 취소한다.",
    "grid.dynamic.design": "셀 디자인",
    "grid.dynamic.design.desc": "그리드에서 우클릭 후 컨텍스트 메뉴에서 샐 색상(CSS)을 추가/삭제 한다.",
    "grid.dynamic.menu.rowadd": "행추가",
    "grid.dynamic.menu.rowdel": "행삭제",
    "grid.dynamic.menu.coladd": "열추가",
    "grid.dynamic.menu.coldel": "열삭제",
    "grid.dynamic.menu.merge": "셀병합 (Ctrl+M)",
    "grid.dynamic.menu.split": "병합취소",
    "grid.dynamic.menu.color": "셀 색상입력",
    "grid.dynamic.menu.cancelcolor": "색상취소",
    "grid.dynamic.merge.required": "한개이상의 셀을 선택하세요.",
    "grid.dynamic.date.invalid": "당일보다 이전의 날짜는 선택할 수 없습니다",
    ...
    // -- 실제 Nexacro stringresource (comp::components.xfdl) --
  ...
  en: {
    ...
    "grid.dynamic.menu.rowadd": "Add row",
    "grid.dynamic.menu.rowdel": "Delete row",
    "grid.dynamic.menu.coladd": "Add column",
    "grid.dynamic.menu.coldel": "Delete column",
    "grid.dynamic.menu.merge": "Merge cells (Ctrl+M)",
    "grid.dynamic.menu.split": "Split cells",
    "grid.dynamic.menu.color": "Apply color",
    "grid.dynamic.menu.cancelcolor": "Clear color",
    "grid.dynamic.merge.required": "Select more than one cell.",
    "grid.dynamic.date.invalid": "You cannot select a date before today.",
