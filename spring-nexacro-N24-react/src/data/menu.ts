...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: "10200", parentId: "10000", label: "다양한 표현", labelEn: "Renderer", path: "/m/renderer", nexacroMenuId: "10200", xfdlFile: "grid::renderer.xfdl", target: "nexacro", tooltip: "그리드 데이터를 셀 표시 유형/ 트리 그룹핑/ 멀티포맷/ 표현식 등으로 표현 해 줍니다.", tooltipEn: "It expresses grid data in cell display type/tree grouping/multi-format/expression, etc." },
  { id: "10300", parentId: "10000", label: "페이징", labelEn: "Pagination", path: "/m/pagination", nexacroMenuId: "10300", xfdlFile: "grid::pagination.xfdl", target: "nexacro", tooltip: "버튼 스타일과 무한 스크롤 타입으로 페이징이 가능 합니다.", tooltipEn: "Paging is possible with button style and infinite scroll type.", serveDirect: true },
  { id: "10400", parentId: "10000", label: "개인화", labelEn: "Personalization", path: "/m/personalization", nexacroMenuId: "10400", xfdlFile: "grid::personalization.xfdl", target: "nexacro", tooltip: "사용자마다 원하는 포맷을 유지 할 수 있습니다.", tooltipEn: "Each user can maintain the desired format." },
  { id: "10500", parentId: "10000", label: "피벗", labelEn: "Pivot", path: "/m/pivot", nexacroMenuId: "10500", xfdlFile: "grid::pivot.xfdl", target: "nexacro", tooltip: "데이터를 원하는 행/열로 피봇팅하여 표현합니다.", tooltipEn: "Represent data by pivoting it to the desired row/column." },
  { id: "10600", parentId: "10000", label: "대용량 데이터", labelEn: "Large Data", path: "/m/largedata", nexacroMenuId: "10600", xfdlFile: "grid::largedata.xfdl", target: "nexacro", tooltip: "많은 양의 데이터를 조회 가능 합니다.", tooltipEn: "A large amount of data can be viewed." },
  { id: "11300", parentId: "10000", label: "분할 조회", labelEn: "Split lookup", path: "/m/progressload", nexacroMenuId: "11300", xfdlFile: "grid::progressload.xfdl", target: "nexacro", tooltip: "대용량 데이터 조회 시 row 단위로 분할 조회 합니다.", tooltipEn: "When searching for large amounts of data, split search by row unit." },
  { id: "10700", parentId: "10000", label: "퀀텀 그리드", labelEn: "Quantum Grid", path: "/m/quantum", nexacroMenuId: "10700", xfdlFile: "grid::quantum.xfdl", target: "nexacro", tooltip: "그리드 데이터를 동적으로 그룹핑 하여 트리 형태로 표현합니다.", tooltipEn: "Grid data is dynamically grouped and expressed in tree form." },
  { id: "10800", parentId: "10000", label: "틀 고정", labelEn: "Freeze Panes", path: "/m/freezepanes", nexacroMenuId: "10800", xfdlFile: "grid::freezepanes.xfdl", target: "nexacro", tooltip: "그리드 스크롤시 원하는 셀을 고정 할 수 있습니다.", tooltipEn: "You can freeze any cell you want when the grid scrolls." },
  { id: "10900", parentId: "10000", label: "스마트 스크롤", labelEn: "Smart Scroll", path: "/m/smartscroll", nexacroMenuId: "10900", xfdlFile: "grid::smartscroll.xfdl", target: "nexacro", tooltip: "그리드 스크롤시 고속의 스크롤을 지원 합니다.", tooltipEn: "Supports high-speed scrolling during grid scrolling." },
  { id: "11000", parentId: "10000", label: "내려받기 & 가져오기", labelEn: "Export & Import", path: "/m/export", nexacroMenuId: "11000", xfdlFile: "grid::export.xfdl", target: "nexacro", tooltip: "엑셀로 Export & Import 가능 합니다.", tooltipEn: "Export & Import to Excel is possible." },
  { id: "11100", parentId: "10000", label: "복사 & 붙여넣기", labelEn: "Copy & Paste", path: "/m/copypaste", nexacroMenuId: "11100", xfdlFile: "grid::copypaste.xfdl", target: "nexacro", tooltip: "그리드와 엑셀 간의 복사 & 붙여넣을 수 있습니다.", tooltipEn: "You can copy & paste between grid and excel." },
  { id: "11200", parentId: "10000", label: "드래그 & 드롭", labelEn: "Drag & Drop", path: "/m/dragndrop", nexacroMenuId: "11200", xfdlFile: "grid::dragndrop.xfdl", target: "nexacro", tooltip: "원하는 컬럼으로 그리드를 동적으로 생성, 데이터 이동이 가능 합니다.", tooltipEn: "It is possible to dynamically create a grid with desired columns and move data." },
  ...
  { id: "20600", parentId: "20000", label: "Fit to Contents", labelEn: "Fit to Contents", path: "/m/fittocontents", nexacroMenuId: "20600", xfdlFile: "comp::fittocontents.xfdl", target: "nexacro", tooltip: "텍스트의 사이즈에 따라 컴포넌트의 크기 자동 조정이 가능 합니다.", tooltipEn: "It is possible to automatically adjust the size of the component according to the size of the text." },
  { id: "20700", parentId: "20000", label: "컴포넌트 동적 생성", labelEn: "Dynamic Generate", path: "/m/generate", nexacroMenuId: "20700", xfdlFile: "comp::generate.xfdl", target: "nexacro", tooltip: "컴포넌트의 동적 생성 시간을 확인 할 수 있습니다.", tooltipEn: "You can check the dynamic creation time of the component." },
  { id: "20800", parentId: "20000", label: "구글 지도", labelEn: "Google Map", path: "/m/googlemap", nexacroMenuId: "20800", xfdlFile: "comp::googlemap.xfdl", target: "nexacro", tooltip: "구글맵 컴포넌트로 손쉽게 구글 지도 연동이 가능 합니다.", tooltipEn: "Google Maps can be easily linked with Google Maps component." },
  { id: "20900", parentId: "20000", label: "다양한 메뉴 표현", labelEn: "Menu", path: "/m/menu", nexacroMenuId: "20900", xfdlFile: "comp::menu.xfdl", target: "nexacro", tooltip: "다양한 메뉴로 화면을 유연하게 구성 할 수 있습니다.", tooltipEn: "You can flexibly configure the screen with various menus." },
  { id: "21000", parentId: "20000", label: "양방향 바인딩", labelEn: "Two-way Data binding", path: "/m/binding", nexacroMenuId: "21000", xfdlFile: "comp::binding.xfdl", target: "nexacro", tooltip: "데이터셋과 바인드된 모든 컴포넌트의 데이터를 자동으로 실시간 동기화 합니다.", tooltipEn: "Data of all components bound to the dataset are automatically synchronized in real time." },
  { id: "21100", parentId: "20000", label: "그래픽스", labelEn: "Graphics", path: "/m/graphics", nexacroMenuId: "21100", xfdlFile: "comp::graphics.xfdl", target: "nexacro", tooltip: "그래픽스 컴포넌트로 선이나 도형을 그릴 수 있습니다.", tooltipEn: "You can draw lines or shapes with the graphics component." },
