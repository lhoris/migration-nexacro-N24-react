...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: "21200", parentId: "20000", label: "애니메이션", labelEn: "Animation", path: "/m/animation", nexacroMenuId: "21200", xfdlFile: "comp::animation.xfdl", target: "react", tooltip: "애니메이션 동적 효과를 적용합니다.", tooltipEn: "Apply animation dynamic effects." },
  { id: "21300", parentId: "20000", label: "Arrangement", labelEn: "Arrangement", path: "/m/arrangement", nexacroMenuId: "21300", xfdlFile: "comp::arrangement.xfdl", target: "react", tooltip: "상대좌표로 컴포넌트의 위치 설정이 가능 합니다.", tooltipEn: "It is possible to set the position of the component in relative coordinates." },
